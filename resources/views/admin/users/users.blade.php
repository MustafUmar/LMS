...
@section('content')
    ...
    @component('shared.pageheader', ['links' => [['Dashboard','/admin/dashboard'], ['Users']]])
    Users
    @endcomponent
    	...
    	<div class="col-md-12">
    		<div class="c_panel">
    			...
    			<div class="c_content">
    				...
    				<table id="users-table" class="table table-striped table-bordered" style="border-spacing:0px; width:100%;">
    					<thead>
                            <tr>
                                <th>First Name</th>
                                <th>Last Name</th>
